...
const formated_previouswork = previouswork.map((value, index) => <li className="col-xs-12 col-sm-6" key={index}><img src="http://placehold.it/300x200" className="img-rounded"/></li>);
